...
func (m *CPUTempPlugin) Describe() (plugin.Descriptor, error) {
...
func (m *CPUTempPlugin) Sample() (plugin.Payload, error) {
	// Get CPU temperature
...
// The CPU temp plugin uses the "unit" config to switch between Celsius and Fahrenheit,
...
func main() {
	goplugin.Serve(&goplugin.ServeConfig{
		...
		Plugins: goplugin.PluginSet{
			"plugin": &plugin.ExecPlugin{Impl: NewCPUTempPlugin()},
		},
	})
}
